  ...
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::dynamic_introspection::IntrospectionMsg_<ContainerAllocator>& v)
  {
    ...
    for (size_t i = 0; i < v.bools.size(); ++i)
    {
      if (false && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer< ::dynamic_introspection::BoolParameter_<ContainerAllocator> >::stream(s, false ? std::string() : indent + "    ", v.bools[i]);
    }
    if (v.bools.empty() || false)
      s << "]";
    if (true || !indent.empty())
    ...
    for (size_t i = 0; i < v.doubles.size(); ++i)
    {
      if (false && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer< ::dynamic_introspection::DoubleParameter_<ContainerAllocator> >::stream(s, false ? std::string() : indent + "    ", v.doubles[i]);
    }
    if (v.doubles.empty() || false)
      s << "]";
    if (true || !indent.empty())
    ...
    for (size_t i = 0; i < v.ints.size(); ++i)
    {
      if (false && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer< ::dynamic_introspection::IntParameter_<ContainerAllocator> >::stream(s, false ? std::string() : indent + "    ", v.ints[i]);
    }
    if (v.ints.empty() || false)
      s << "]";
    if (true || !indent.empty())
    ...
    for (size_t i = 0; i < v.markers.size(); ++i)
    {
      if (false && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer< ::dynamic_introspection::MarkerParameter_<ContainerAllocator> >::stream(s, false ? std::string() : indent + "    ", v.markers[i]);
    }
    if (v.markers.empty() || false)
      s << "]";
  }
