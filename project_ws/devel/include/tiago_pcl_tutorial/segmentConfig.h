...
//#line 292 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __default__.image = 1;
//#line 292 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(segmentConfig::AbstractParamDescriptionConstPtr(new segmentConfig::ParamDescription<int>("image", "int", 0, "A PointCloud2 origin param which is edited via an enum", "{'enum': [{'name': 'original_image', 'type': 'int', 'value': 0, 'srcline': 15, 'srcfile': '/home/milenavi/project_ws/src/assignment_5/tiago_tutorials/tiago_pcl_tutorial/cfg/segment.cfg', 'description': 'original image', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'filtered_image', 'type': 'int', 'value': 1, 'srcline': 16, 'srcfile': '/home/milenavi/project_ws/src/assignment_5/tiago_tutorials/tiago_pcl_tutorial/cfg/segment.cfg', 'description': 'filtered image', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'An enum to choose origin PointCloud2'}", &segmentConfig::image)));
//#line 292 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(segmentConfig::AbstractParamDescriptionConstPtr(new segmentConfig::ParamDescription<int>("image", "int", 0, "A PointCloud2 origin param which is edited via an enum", "{'enum': [{'name': 'original_image', 'type': 'int', 'value': 0, 'srcline': 15, 'srcfile': '/home/milenavi/project_ws/src/assignment_5/tiago_tutorials/tiago_pcl_tutorial/cfg/segment.cfg', 'description': 'original image', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'filtered_image', 'type': 'int', 'value': 1, 'srcline': 16, 'srcfile': '/home/milenavi/project_ws/src/assignment_5/tiago_tutorials/tiago_pcl_tutorial/cfg/segment.cfg', 'description': 'filtered image', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'An enum to choose origin PointCloud2'}", &segmentConfig::image)));
//#line 292 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __min__.method = 0;
//#line 292 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __max__.method = 3;
...
//#line 15 "/home/milenavi/project_ws/src/assignment_5/tiago_tutorials/tiago_pcl_tutorial/cfg/segment.cfg"
      const int segment_original_image = 0;
//#line 16 "/home/milenavi/project_ws/src/assignment_5/tiago_tutorials/tiago_pcl_tutorial/cfg/segment.cfg"
      const int segment_filtered_image = 1;
//#line 20 "/home/milenavi/project_ws/src/assignment_5/tiago_tutorials/tiago_pcl_tutorial/cfg/segment.cfg"
      const int segment_Plane = 0;
//#line 21 "/home/milenavi/project_ws/src/assignment_5/tiago_tutorials/tiago_pcl_tutorial/cfg/segment.cfg"
      const int segment_Cylindrical = 1;
//#line 22 "/home/milenavi/project_ws/src/assignment_5/tiago_tutorials/tiago_pcl_tutorial/cfg/segment.cfg"
