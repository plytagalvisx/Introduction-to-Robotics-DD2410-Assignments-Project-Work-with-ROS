...
if("TRUE" STREQUAL "TRUE")
  set(pal_gazebo_plugins_SOURCE_PREFIX /home/milenavi/project_ws/src/assignment_5/pal_gazebo_plugins)
  set(pal_gazebo_plugins_DEVEL_PREFIX /home/milenavi/project_ws/devel)
  ...
  set(pal_gazebo_plugins_INSTALL_PREFIX /home/milenavi/project_ws/install)
...
if(NOT "/home/milenavi/project_ws/src/assignment_5/pal_gazebo_plugins/include;/usr/include;/usr/include/gazebo-11;/usr/include/bullet;/usr/include/simbody;/usr/include/sdformat-9.10;/usr/include/ignition/math6;/usr/include/OGRE;/usr/include/OGRE/Terrain;/usr/include/OGRE/Paging;/usr/include/ignition/transport8;/usr/include/ignition/msgs5;/usr/include/ignition/common3;/usr/include/ignition/fuel_tools4 " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pal_gazebo_plugins' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/milenavi/project_ws/src/assignment_5/pal_gazebo_plugins/${idir}'.  ${_report}")
    endif()
    _list_append_unique(pal_gazebo_plugins_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "gazebo_ros_forcetorque;gazebo_pal_hand;gazebo_wifi_ap;gazebo_underactuated_finger;BulletSoftBody;BulletDynamics;BulletCollision;LinearMath;/usr/lib/aarch64-linux-gnu/libSimTKcommon.so.3.6;/usr/lib/aarch64-linux-gnu/libSimTKmath.so.3.6;/usr/lib/aarch64-linux-gnu/libSimTKsimbody.so.3.6;/usr/lib/aarch64-linux-gnu/libdart.so.6.9.2;/usr/lib/aarch64-linux-gnu/libgazebo.so;/usr/lib/aarch64-linux-gnu/libgazebo_client.so;/usr/lib/aarch64-linux-gnu/libgazebo_gui.so;/usr/lib/aarch64-linux-gnu/libgazebo_sensors.so;/usr/lib/aarch64-linux-gnu/libgazebo_rendering.so;/usr/lib/aarch64-linux-gnu/libgazebo_physics.so;/usr/lib/aarch64-linux-gnu/libgazebo_ode.so;/usr/lib/aarch64-linux-gnu/libgazebo_transport.so;/usr/lib/aarch64-linux-gnu/libgazebo_msgs.so;/usr/lib/aarch64-linux-gnu/libgazebo_util.so;/usr/lib/aarch64-linux-gnu/libgazebo_common.so;/usr/lib/aarch64-linux-gnu/libgazebo_gimpact.so;/usr/lib/aarch64-linux-gnu/libgazebo_opcode.so;/usr/lib/aarch64-linux-gnu/libgazebo_opende_ou.so;/usr/lib/aarch64-linux-gnu/libboost_system.so.1.71.0;/usr/lib/aarch64-linux-gnu/libboost_filesystem.so.1.71.0;/usr/lib/aarch64-linux-gnu/libboost_program_options.so.1.71.0;/usr/lib/aarch64-linux-gnu/libboost_regex.so.1.71.0;/usr/lib/aarch64-linux-gnu/libboost_iostreams.so.1.71.0;/usr/lib/aarch64-linux-gnu/libprotobuf.so;/usr/lib/aarch64-linux-gnu/libsdformat9.so.9.10.1;optimized;/usr/lib/aarch64-linux-gnu/libOgreMain.so;debug;/usr/lib/aarch64-linux-gnu/libOgreMain.so;/usr/lib/aarch64-linux-gnu/libboost_date_time.so.1.71.0;optimized;/usr/lib/aarch64-linux-gnu/libOgreTerrain.so;debug;/usr/lib/aarch64-linux-gnu/libOgreTerrain.so;optimized;/usr/lib/aarch64-linux-gnu/libOgrePaging.so;debug;/usr/lib/aarch64-linux-gnu/libOgrePaging.so;/usr/lib/aarch64-linux-gnu/libignition-math6.so.6.15.1;/usr/lib/aarch64-linux-gnu/libignition-transport8.so.8.5.0;/usr/lib/aarch64-linux-gnu/libignition-msgs5.so.5.11.0;/usr/lib/aarch64-linux-gnu/libignition-common3-graphics.so.3.17.0;/usr/lib/aarch64-linux-gnu/libignition-fuel_tools4.so.4.9.1;/usr/lib/aarch64-linux-gnu/libboost_thread.so.1.71.0")
