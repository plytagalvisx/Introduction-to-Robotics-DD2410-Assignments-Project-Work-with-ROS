...
class Odometry:
    def __init__(self, header=Header(), child_frame_id="",
        ...
        self.pose = pose # pose is the position and orientation of the robot in the world frame, with covariance (uncertainty)
        self.twist = twist # twist is the velocity of the robot in the world frame, with covariance (uncertainty)
